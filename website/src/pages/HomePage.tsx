import { Title, Text, Button, Group, SimpleGrid, Paper, ThemeIcon, Stack, Container, Anchor, List, Box, BackgroundImage, Overlay, Flex } from '@mantine/core';
import { IconCheck, IconBrandGithub, IconCalendar, IconRocket, IconCode, IconMail, IconArrowRight, IconBrandGoogle, IconCloud, IconDeviceDesktop, IconUsers } from '@tabler/icons-react';
    ...
    <Stack gap="xl">
            ...
            <Stack gap="xl" style={{ flex: 1, minWidth: 300, maxWidth: 600 }}>
              ...
              <Group gap="xl" mt="xl">
                ...
                <Stack gap={4}>
                  ...
                  <Text size="sm" c="dimmed">Foundation</Text>
                </Stack>
              </Group>
            </Stack>
      ...
      <Box id="features" py="xl" style={{ background: 'linear-gradient(to bottom, #ffffff 0%, #f7fdf9 100%)', borderRadius: 'lg' }}>
        <Container size="lg">
          <Stack gap="xl">
            <div>
              <Text size="sm" fw={600} c="green.8" tt="uppercase" ta="center" mb="xs">Features</Text>
              <Title order={2} ta="center" mb="md">Everything your club needs</Title>
              <Text size="lg" c="dimmed" ta="center" maw={800} mx="auto">
                A complete platform designed specifically for grassroots football clubs
              </Text>
            </div>
                  ...
                  <Stack gap="md">
                    <Group>
                      <ThemeIcon size={48} radius="lg" variant="light" color="green.6">
                        {i === 0 && <IconDeviceDesktop size={24} />}
                        {i === 1 && <IconCalendar size={24} />}
                        {i === 2 && <IconUsers size={24} />}
                        {i === 3 && <IconBrandGoogle size={24} />}
                        {i === 4 && <IconCloud size={24} />}
                        {i === 5 && <IconCode size={24} />}
                      </ThemeIcon>
                    ...
                    <List spacing="xs" size="sm">
                      {feature.details.map((detail, idx) => (
                         <List.Item key={idx} icon={<IconCheck size={14} color="var(--mantine-color-green-6)" />}>
                          {detail}
                        </List.Item>
                      ))}
                    </List>
      ...
      <Box id="contact" py="xl" style={{ background: 'linear-gradient(135deg, #1a2332 0%, #273347 100%)', borderRadius: 'lg' }}>
        <Container size="lg">
          <Stack gap="xl" align="center">
            <div>
              <Text size="sm" fw={600} c="green.3" tt="uppercase" ta="center" mb="xs">Contact</Text>
